            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="selectSaleModalLabel">Select Sale Representative</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="selectSaleForm" method="post" action="updateSaleManagement">
                            <input type="hidden" name="orderId" id="orderId" value="">
                            <div class="mb-3">
                                <label for="saleSelect" class="form-label">Sales Representative</label>
                                <select class="form-select" id="saleSelect" name="saleId" required>
