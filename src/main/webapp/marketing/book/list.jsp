...
<html>
    ...
    <body>
        <div class="container mt-5">
            ...
            <a href="home" class="btn btn-primary btn-sm mb-2">Back to home</a>
                    ...
                    <c:forEach var="book" items="${books}">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="marketing-product?action=delete&id=${book.bookId}" class="btn btn-danger btn-sm">Delete</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
